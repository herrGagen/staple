...
\draw (1.75,0) +(-1,-.25) rectangle ++(1,.25);
\draw (1.75,0) node{$B_1 \hdots B_1$};
\draw (3.5,0) +(-.75,-.25) rectangle ++(.75,.25);
\draw (3.5,0) node{$f_4 f_5 f_6 f_6$};
\draw (5.25,0) +(-1,-.25) rectangle ++(1,.25);
\draw (5.25,0) node{$B_2 \hdots B_2$};
\draw (7.25,0) +(-1,-.25) rectangle ++(1,.25);
\draw (7.25,0) node{$SSSSSS$};
\end{tikzpicture}
\end{figure}
